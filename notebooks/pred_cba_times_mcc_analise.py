...
IN_PATH = '/home/jgcarvalho/zeca-analyse-pos_quali/Top8000-best_hom50_pdb_chain/cba_times_mcc/rose_special_charged/run_10000/csv_results/*'
...
def main():
    save_q3('pred_cba_times_mcc_q3.csv')
    save_qh('pred_cba_times_mcc_qh.csv')
    save_qe('pred_cba_times_mcc_qe.csv')
    save_qc('pred_cba_times_mcc_qc.csv')
